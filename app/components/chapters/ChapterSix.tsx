        ...
        <section className="h-screen w-full snap-start flex flex-col md:flex-row items-center justify-center p-8 bg-background relative overflow-hidden">
            ...
            <div className="flex-1 max-w-xl p-8 animate-in slide-in-from-left duration-700">
                <div className="mb-6">
                    ...
                    <h2 className="text-4xl font-extrabold mb-4">{config.education.title}</h2>
                </div>
                ...
                <StoryCard title={config.education.subtitle}>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold">{config.education.degree}</h3>
                            <p className="text-muted-foreground text-lg">{config.education.university}</p>
                            <p className="text-sm text-muted-foreground mt-1">{config.education.location} | {config.education.year}</p>
                        </div>
                    </div>
